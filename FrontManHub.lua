-- ✅ Loading Screen (อยู่จอนานขึ้น + ตัวอักษรใหญ่ขึ้น + Fade Out ช้าลง) local LoadingGui = Instance.new("ScreenGui") local LoadingText = Instance.new("TextLabel")

LoadingGui.Name = "FrontManLoading" LoadingGui.Parent = game:GetService("CoreGui") LoadingGui.IgnoreGuiInset = true LoadingGui.ResetOnSpawn = false

LoadingText.Parent = LoadingGui LoadingText.Size = UDim2.new(0, 400, 0, 120) LoadingText.Position = UDim2.new(0.5, -200, 0.5, -60) LoadingText.BackgroundTransparency = 1 LoadingText.Text = "Front Man" LoadingText.TextColor3 = Color3.fromRGB(0, 255, 255) LoadingText.Font = Enum.Font.GothamBold LoadingText.TextSize = 60 LoadingText.TextStrokeTransparency = 0.3 LoadingText.TextStrokeColor3 = Color3.fromRGB(0, 255, 255)

local TweenService = game:GetService("TweenService")

task.wait(3.5)

local FadeTween = TweenService:Create(LoadingText, TweenInfo.new(2.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { TextTransparency = 1, TextStrokeTransparency = 1 })

FadeTween:Play()

FadeTween.Completed:Connect(function() LoadingGui:Destroy()
